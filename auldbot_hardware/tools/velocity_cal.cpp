// Measures velocity_scale for auldbot_hardware.
//
...
//
// Build: added as `velocity_cal` in auldbot_hardware/CMakeLists.txt.
// Run:   ros2 run auldbot_hardware velocity_cal [servo_id] [serial_port] [baud]
//        e.g. ros2 run auldbot_hardware velocity_cal 7
//
...
int main(int argc, char* argv[])
{
    ...
    const char* port = (argc > 2) ? argv[2] : "/dev/auldbot_servos";
    ...
    std::printf("  auldbot_description/urdf/auldbot.urdf.xacro  (velocity_scale default)\n");
    std::printf("  auldbot_bringup/launch/auldbot_launch.py      (velocity_scale value)\n");
