...
pixi run -e fleet fleet-broker-ws  # Mosquitto + WebSockets (container; the dashboard needs it)
pixi run -e fleet fleet-broker     # conda's mosquitto: MQTT only, no dashboard
